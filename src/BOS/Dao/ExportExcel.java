...
public class ExportExcel {
	...
	public void createNormalTwoRow(String[] params, int colSum) {
		...
		HSSFCellStyle cellStyle = wb.createCellStyle();
		cellStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER);// 指定单元格居中
		cellStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);// 指定单元格对齐
		cellStyle.setWrapText(true);// 指定单元格自动换行
	...
	public void createColumHeader(String[] columHeader) {
		...
		HSSFCellStyle cellStyle = wb.createCellStyle();
		cellStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER);// 指定单元格居中
		cellStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER);// 指定行对齐
		cellStyle.setWrapText(true);// 指定单元格自动换行
